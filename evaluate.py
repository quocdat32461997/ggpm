...
parser.add_argument('--use-preds', action='store_true', default=False)
...
def evaluate_optim(args):
    ...
    homo_net, lumo_net = None, None
    if not args.use_preds:
    ...
    optim_metrics = metrics.get_optim_metrics(
        homos=args.output_homos,
        lumos=args.output_lumos,
